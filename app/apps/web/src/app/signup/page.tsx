      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Join SocialConnect</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {formData.password.length > 0 && (
                <div className="mt-2 text-sm">
                  <div className={`flex items-center ${isPasswordValid ? "text-green-600" : "text-red-600"}`}>
                    <Check className={`w-4 h-4 mr-1 ${isPasswordValid ? "text-green-600" : "text-red-600"}`} />
            ...
            <div>
              ...
              {formData.confirmPassword.length > 0 && (
                <div className="mt-2 text-sm">
                  <div className={`flex items-center ${isConfirmPasswordValid ? "text-green-600" : "text-red-600"}`}>
                    <Check className={`w-4 h-4 mr-1 ${isConfirmPasswordValid ? "text-green-600" : "text-red-600"}`} />
                    Passwords match
                  </div>
                </div>
              )}
            ...
            <button
              type="submit"
              disabled={isLoading || !agreedToTerms || !isPasswordValid || !isConfirmPasswordValid}
